...
class InvoiceScreenLeftButton extends StatefulWidget {
  final Function(int) onItemCliked;

  const InvoiceScreenLeftButton({super.key, required this.onItemCliked});

  @override
  State<InvoiceScreenLeftButton> createState() =>
